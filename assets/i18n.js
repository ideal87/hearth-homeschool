...
var STRINGS = {
  en: {
    ...
    teamHint:'Half of everyone’s stars, collected together',
    statToday:'today',
    statWeek:'this week',
    statTotal:'total',
  ...
  es: {
    ...
    teamHint:'La mitad de las estrellas de todos, juntas',
    statToday:'hoy',
  ...
  fr: {
    ...
    teamHint:'La moitié des étoiles de chacun, réunies',
