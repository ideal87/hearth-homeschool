...
var STRINGS = {
  en: {
    ...
    bonusPending:'Finish all {n} for a {b}-star bonus',
    bonusWon:'Whole {slot} finished - bonus {b} stars!',
    allDone:'Everything done today!',
    starsEarned:'{n} stars earned',
    plusStars:'+{n} stars!',
    toastStars:'{name} +{n} stars',
    toastSlot:'{name} finished the whole {slot}! +{b}',
    greeting:'Hi, {name}!',
    ...
    slotDoneKid:'{slot} all done! +{b} bonus stars',
  ...
  ko: {
    ...
    bonusPending:'{n}개를 모두 끝내면 보너스 별 {b}개',
    bonusWon:'{slot} 전부 완료! 보너스 별 {b}개!',
    allDone:'오늘 할 일을 다 했어요!',
    starsEarned:'별 {n}개 획득',
    plusStars:'별 +{n}개!',
    toastStars:'{name} 별 +{n}개',
    toastSlot:'{name} {slot} 전부 완료! +{b}',
    greeting:'안녕, {name}!',
    ...
    slotDoneKid:'{slot} 전부 완료! 보너스 별 {b}개',
  ...
  es: {
    ...
    bonusPending:'Termina las {n} y gana {b} estrellas extra',
    bonusWon:'¡Rutina completa! Bonus de {b} estrellas',
    allDone:'¡Todo hecho por hoy!',
    starsEarned:'{n} estrellas ganadas',
    plusStars:'¡+{n} estrellas!',
    toastStars:'{name} +{n} estrellas',
    toastSlot:'¡{name} completó la rutina! +{b}',
    greeting:'¡Hola, {name}!',
    ...
    slotDoneKid:'¡Rutina completa! +{b} estrellas extra',
  ...
  fr: {
    ...
    bonusPending:'Termine les {n} pour {b} étoiles bonus',
    bonusWon:'Routine terminée ! Bonus de {b} étoiles',
    allDone:'Tout est fini pour aujourd’hui !',
    starsEarned:'{n} étoiles gagnées',
    plusStars:'+{n} étoiles !',
    toastStars:'{name} +{n} étoiles',
    toastSlot:'{name} a fini la routine ! +{b}',
    greeting:'Salut, {name} !',
    ...
    slotDoneKid:'Routine terminée ! +{b} étoiles bonus',
