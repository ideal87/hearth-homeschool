...
var STRINGS = {
  en: {
    ...
    teamHint:'Every chore star lands here, for treats you all share',
    dayClosed:'This day is finished',
    dayClosedHint:'The stars are saved. Changing tasks now cannot change this day.',
    earnedThatDay:'⭐ {n} earned',
    teamThatDay:'🤝 {n} to the team',
    statPot:'in the pot',
    toTeam:'🤝 to the team',
    toastTeam:'Team +{n} stars',
    statToday:'today',
    statWeek:'this week',
    statTotal:'total',
    ofMaxToday:'⭐ {n} / {m} today',
    weekOfMax:'📅 {n} / {m} this week',
    language:'Language'
  },
  ko: {
    ...
    rewardSection:'보상',
    teamStars:'팀 별',
    teamHint:'집안일 별은 모두 여기에 모여, 함께 쓰는 상이 돼요',
    dayClosed:'끝난 날이에요',
    dayClosedHint:'별은 그대로 저장됐어요. 이제 할 일을 바꿔도 이 날은 바꿌지 않아요.',
    earnedThatDay:'⭐ {n}개 받음',
    teamThatDay:'🤝 팀에 {n}개',
    statPot:'모은 별',
    toTeam:'🤝 팀에게',
    toastTeam:'팀 별 +{n}개',
  ...
  es: {
    ...
    teamStars:'Estrellas del equipo',
    teamHint:'Cada estrella de las tareas viene aquí, para premios de todos',
    dayClosed:'Este día ya está cerrado',
    dayClosedHint:'Las estrellas están guardadas. Cambiar tareas ahora no cambia este día.',
    earnedThatDay:'⭐ {n} ganadas',
    teamThatDay:'🤝 {n} al equipo',
    statPot:'en el bote',
    toTeam:'🤝 al equipo',
    toastTeam:'Equipo +{n} estrellas',
    statToday:'hoy',
    statWeek:'esta semana',
    statTotal:'en total',
    ofMaxToday:'⭐ {n} / {m} hoy',
    weekOfMax:'📅 {n} / {m} esta semana',
    language:'Idioma'
  },
  fr: {
    ...
    teamStars:'Étoiles d’équipe',
    teamHint:'Chaque étoile de tâche arrive ici, pour des plaisirs partagés',
    dayClosed:'Cette journée est terminée',
    dayClosedHint:'Les étoiles sont enregistrées. Modifier les tâches ne change plus ce jour.',
    earnedThatDay:'⭐ {n} gagnées',
    teamThatDay:'🤝 {n} pour l’équipe',
    statPot:'dans la cagnotte',
    toTeam:'🤝 pour l’équipe',
    toastTeam:'Équipe +{n} étoiles',
    statToday:'aujourd’hui',
    statWeek:'cette semaine',
    statTotal:'au total',
    ofMaxToday:'⭐ {n} / {m} aujourd’hui',
    weekOfMax:'📅 {n} / {m} cette semaine',
    language:'Langue'
  }
};
